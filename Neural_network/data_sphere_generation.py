...
torch.save({'data': train_data, 'labels': train_labels}, '/beegfs/jhermant/Momentum_Stochastic_GD/dataset/sphere/train_dataset_sphere.pth')
torch.save({'data': test_data, 'labels': test_labels}, '/beegfs/jhermant/Momentum_Stochastic_GD/dataset/sphere/test_dataset_sphere.pth')
